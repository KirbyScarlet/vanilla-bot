...
NONEBOT_PLUGIN_MESSAGE_VERSION = message_core_config.message_core_version
class Config(BaseModel):
    message_api: str = "console"
    message_index_name: str = "{bot_name}-message-{driver_name}-{bot_id}-{version}"
    message_objects_storage: str = "console"
    message_image_index_name: str = "{bot_name}-image-{version}"
    message_file_index_name: str = "{bot_name}-file-{version}"
